			...
			<div className="mx-1 shadow-sm border border-secondary border-2" style={cardStyle}>
				...
				{game === 'express-yourself-game' && (
					<>
						{showCorrectAnswer ? (
							...
							<>
								{renderCommonSections('Write the above Dutch Sentence in French:')}
				...
				{game === 'study-the-dialogue' && (
					<>
						...
						<DutchSentence dutchSentence={'Practice The Dialogue'} />
						<hr className="border border-1 border-secondary opacity-25 mx-2 mt-0 mb-0 rounded" />
						...
						<>
							{toggleScreen ? (
								<InstructionSentence
									...
									marginBottom={'mb-20'}
									InstructionText={
										'Select all the words you want to place in the sound library'
									}
								/>
							) : (
								<InstructionSentence
									...
									marginBottom={'mb-20'}
									InstructionText={
										'Write the French Translation of the Dutch words below:'
									}
								/>
							)}
						</>
						...
						<div className="text-start">
							{!toggleScreen ? (
								<div className="mt-10 text-end mx-2">
									{renderProceedButton('Submit', true)}
								</div>
							) : (
								<div className="mt-10 text-end mx-2">
									{renderPromptButton(
