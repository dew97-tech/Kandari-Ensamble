...
const Frame2 = ({ index, guessedWord, answers, setAnswers }) => {
	return (
		<>
			<span id="guessword" name="guessword" className="d-flex align-items-center justify-content-center h6 buff-text-color pt-2 pb-1">
			...
			>
				...
				>
					...
					<b name="guessword" className="text-left mr-15 buff-text-color">
					...
					<input
						...
						className="form-control border border-secondary border-1 rounded-3 buff-text-color shadow-sm my-0"
						id="guessword"
