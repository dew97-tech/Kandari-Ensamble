...
const SoundLibraryGame = ({exerciseTitle}) => {
   // Context
   const { handleGameStart, isGameStarted, evaluateAnswers, toggleScreen, checkedItems, handlePrompt } =
